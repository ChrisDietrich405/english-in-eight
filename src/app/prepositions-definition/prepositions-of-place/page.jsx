...
export default function PrepositionsOfPlace() {
  ...
  },
  {
     ...
     userAnswer: "",
     explanation: "On is used when referring to something that is on a surface."
  },
  {
     id: 3,
     ...
     possibleAnswers: [{ title: "on" }, { title: "in", correctAnswer: true }],
     userAnswer: "",
     explanation: "At is used when referring to something at a specific point."
  },
  {
     id: 4,
  ...
  {
     id: 15,
     title: "The birds are ______ the tree.",
     possibleAnswers: [{ title: "in" }, { title: "on" }],
     userAnswer: "",
     explanation: "In is used when referring to something that is in something else."
  },
  {
     id: 16,
  ...
  return (
    <main>
      ...
      <div className="page-examples">
        ...
        <ul>
          <li>I dropped something <b>on</b> the document.</li>
          <li>I hung the picture <b>on</b> the wall.</li>
          <li>The drinks are <b>on</b> the menu.</li>
        </ul>
        <p className="{styles.grammar_explanation_paragraph}">
         We use <b>in</b> to refer to something that is inside.
        </p>
        <ul>
          <li>The veggie burgers are <b>in</b> the fridge.</li>
          <li>She's <b>in</b> the hospital.</li>
          <li>Marcus is <b>in</b> Kenya, visiting his friend <b>in</b> the hospital.</li>
        </ul>
        <p className="{styles.grammar_explanation_paragraph}">
          We use <b>at</b> to refer to something at a specific point.
         </p>
         <ul>
           <li>He waited <b>at</b> the bus stop for 2 hours.</li>
           <li>They’ll meet <b>at</b> the airport.</li>
           <li>They are <b>at</b> the movies.</li>
         </ul>
